...
echo
	...
	limalinuxVersion='v26.01.30.01'

	isoLabel='limalinux_'$limalinuxVersion'_x86_64.iso'

	# setting of the general parameters
	archisoRequiredVersion="archiso 84-1"
	buildFolder=$HOME"/limalinux_build"
	outFolder=$HOME"/limalinux_Out"
...
echo
	...
	echo "Building version                       : "$limalinuxVersion
