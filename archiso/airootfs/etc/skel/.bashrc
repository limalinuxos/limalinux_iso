...
#keyboard
alias give-me-azerty-es="sudo localectl set-x11-keymap es"
alias give-me-qwerty-us="sudo localectl set-x11-keymap us"

#setlocale
alias setlocale="sudo localectl set-locale LANG=es_ES.UTF-8"
alias setlocales="sudo localectl set-x11-keymap be && sudo localectl set-locale LANG=es_ES.UTF-8"
